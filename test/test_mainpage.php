...
<body id="body" class = "<?= $_SESSION['theme']?>">
    <section id="courses">
    ...
    <script>
        ...
        // Add course cards
        var courses = [
            { cover: '../img/module/module-1/Cover.jpeg', title: 'Comprendre les Attaques par Déni de Service (DoS et DDoS)', description: 'Dans ce cours, vous apprendrez les mécanismes des attaques DoS et DDoS, leurs impacts sur les systèmes informatiques, et les mesures de protection efficaces. Grâce à des exemples concrets et des explications détaillées, vous serez mieux préparé à reconnaître et contrer ces cybermenaces.', link: 'Demo_1.php'},
            { cover: '../img/module/module-2/Cover.jpeg', title: 'Démystifier les Attaques par Force Brute et par Dictionnaire', description: 'Ce cours explore les attaques par force brute et par dictionnaire, deux techniques couramment utilisées par les cybercriminels pour accéder illégalement aux systèmes et aux données. Vous apprendrez comment ces attaques fonctionnent, leurs différences et leurs similitudes, ainsi que les stratégies efficaces pour les prévenir. Grâce à des exemples pratiques et des explications claires, ce cours vise à vous fournir les connaissances nécessaires pour protéger vos systèmes contre ces menaces courantes.', link: 'Demo_2.php'},
