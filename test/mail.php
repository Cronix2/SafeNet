...
<head><meta name="robots" content="noindex, nofollow"/><meta name="referrer" content="no-referrer"/>
    ...
    <style>
        ...
        @font-face {
            font-family: 'SafeNet Display Bold';
...
<a href="link 3"  title="SafeNet logo" target="_blank">

<img src="https://raw.githubusercontent.com/Cronix2/SafeNet/main/img/SafeNet_Logo_1.png" style="display:block;" alt="SafeNet logo" width="120" border="0">
</a>
            </td>
            <!--end logo-->
        </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
                        <td align="left" style="font-family: 'SafeNet Text', 'SafeNet Display', apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-style: normal;font-weight: normal;font-size: 20px;line-height: 30px;text-align: left;letter-spacing: 0.48px;color: #F8F8F8;" class="Fontth2" > 
...
<tr>
<td align="left"  style="font-family:'SafeNet Display', apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-style: normal;font-weight: bold;font-size: 48px;line-height: 54px;color: #F8F8F8;padding:20px 0;" valign="top">
                                        <b>aléatoire</b>
        ...
        <tr>
                        <td align="left"  style="font-family: 'SafeNet Text', 'SafeNet Display', apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-style: normal;font-weight: normal;font-size: 20px;line-height: 30px;text-align: left;letter-spacing: 0.48px;color: #F8F8F8;" class="Fontth2"> 
                                        ...
                                        Si vous n'avez pas demandé ce code, rendez-vous sur votre page <a href="link"  target="_blank" style="color:#5288FD;text-decoration:underline;">Mon compte</a>  et changez votre mot de passe immédiatement.<br><br>
                                    Merci de nous aider à rendre votre compte plus sûr.<br><br>
                                

                                        Bon apprentissage ! <br>L'équipe de SafeNet
...
<tr>
<td align="left" class="fontth04" style="font-family: 'SafeNet Text', apple-system, sans-serif; color:#908E97; font-size:18px;font-style:normal; font-weight:normal;letter-spacing:0.48px; line-height:25px;" valign="top">
    Cet e-mail est envoyé par SafeNet <br><br>
    <br><br>
    <a  href="link2" target="_blank">Qui Sommes-nous ?</a></td></tr>
<tr>
<td align="center" style="padding: 1px 0px" valign="middle">
    <a  target="_blank"><img alt="Safenet footer icon" border="0" src="https://raw.githubusercontent.com/Cronix2/SafeNet/main/img/SafeNet_Logo_2.png" style="display: block;" width="200"></a></td></tr><!-- <tr>    <td class="fontth04" style="font-family: 'SafeNet Text', apple-system, sans-serif;  font-size: 18px; mso-line-height-rule: exactly; line-height: 25px; color: #908E97; padding-bottom: 25px; letter-spacing:0.48px;" valign="top" align="left">     Origin fait partie du réseau SafeNet.</td></tr>--></table></td></tr></table> </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
...
<img src="https://raw.githubusercontent.com/Cronix2/SafeNet/main/img/SafeNet_Logo_1.png" width="1" height="1" alt="">
</body>
</html>